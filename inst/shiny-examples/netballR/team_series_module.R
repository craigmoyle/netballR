...
team_series <- function(df) {
  df %>%
    ...
    labs(
      y = 'Value',
      title = 'Netball Statistics by Round',
      caption =
        'This figure allows you to compare two teams on a single statistic over time. Overlaid are simple trend (loess) lines and an 80% confidence interval.'
    ) +
    theme_minimal() +
    theme(
